...
def polygons_from_file(file_name, sheet, title):
...
def main():
    ...
    polygons_from_file("Test/dighe.xls", "Dighe1", "Test of instance Dighe.xls")
    # polygons_from_file("Test/albano.xls", "Albano", "Test of instance Albano.xls")
